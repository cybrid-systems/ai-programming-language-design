...
| 符号 | 文件 | 行号 |
|------|------|------|
| `struct netlink_sock` | net/netlink/af_netlink.c | netlink socket |
| `netlink_rcv_skb()` | net/netlink/af_netlink.c | 消息接收 |
| `rtnetlink_rcv()` | net/core/rtnetlink.c | 路由 netlink |
| `rtnl_newlink()` | net/core/rtnetlink.c | 新建链路 |
