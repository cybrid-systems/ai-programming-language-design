...
| `calc_index()` | kernel/time/timer.c | 536 |
| `collect_expired_timers()` | kernel/time/timer.c | 附近 |
| `expire_timers()` | kernel/time/timer.c | 附近 |
| `__run_timers()` | kernel/time/timer.c | 2364 |
| `run_timer_softirq()` | kernel/time/timer.c | 2401 |
| `__run_timer_base()` | kernel/time/timer.c | 2433 |
| `trigger_dyntick_cpu()` | kernel/time/timer.c | 附近 |
| `timer_delete()` | kernel/time/timer.c | 附近 |
| `timer_delete_sync()` | kernel/time/timer.c | 附近 |
| `__try_to_del_timer_sync()` | kernel/time/timer.c | 附近 |
| `timer_shutdown()` | kernel/time/timer.c | 附近 |
