...
| 符号 | 文件 | 行号 |
|------|------|------|
| `wireguard_device_create()` | drivers/net/wireguard/device.c | WG 设备 |
| `wg_receive()` | drivers/net/wireguard/receive.c | 接收路径 |
| `wg_xmit()` | drivers/net/wireguard/send.c | 发送路径 |
| `struct wg_device` | drivers/net/wireguard/device.h | 核心结构 |
