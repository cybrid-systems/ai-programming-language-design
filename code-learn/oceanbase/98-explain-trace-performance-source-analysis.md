...
> 基于 OceanBase 5.0.2.0 主线源码 (commit `f2e437ea62` 之后, OB_BUILD_VERSION "5.0.2.0")（`src/sql/monitor/` **27 文件** + `src/observer/virtual_table/` 多个 explain/trace 类 + `src/sql/executor/` 多个执行类）
