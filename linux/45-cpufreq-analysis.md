...
The CPUFreq subsystem manages processor frequency scaling. It consists of a core framework, architecture-specific drivers, and pluggable governors. The schedutil governor uses scheduler PELT signals for responsive frequency adjustment. Hardware drivers interface with MSR or ACPI to change frequency.
